...
(async () => {
  ...
  */
    ...
    console.log("Logos:");
    logos.forEach((logo) => console.log("logo", logo.description));
    console.log("\n\n   ");
    ...
    let fullText = [];
    detections.forEach((text) => fullText.push(text.description));
    console.log(" text ");
    ...
    landmarks.forEach((landmark) => console.log(`Landmark Description: ${landmark.description}`));
    console.log("\n\n   ");
    ...
    const colors = imagePropsResult.imagePropertiesAnnotation.dominantColors.colors;
    colors.forEach((color) => {
        console.log(`Color RGB: ${color.color.red}, ${color.color.green}, ${color.color.blue}`);
    ...
    objects.forEach((object) => {
        ...
        console.log(`Bounding Poly Coordinates:`, object.boundingPoly.normalizedVertices);
    });
    console.log("\n\n   ");
    ...
    webEntities.forEach((webEntity) => {
        console.log(`Description: ${webEntity.description}, Score: ${webEntity.score}`);
    });
