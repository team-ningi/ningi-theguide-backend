...
exports.updateReportOriginalTagsSchema = joi_1.default.object({
    user_id: joi_1.default.string().required(),
    report_id: joi_1.default.string().required(),
    tagResults: joi_1.default.object().required(),
});
